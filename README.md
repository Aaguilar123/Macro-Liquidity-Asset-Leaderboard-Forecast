...
1. The Joint Notebook (containing the EDA, problem definition, and the GitHub link).

2. Your Individual Notebook (containing your specific model, tuning, and reflection).
